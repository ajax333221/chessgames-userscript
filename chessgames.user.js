...
$(function(){
	...
	if(Ic && IcUi && temp.length>10){
		...
		my_css+=".ic_ui_board .ic_piece_holder, #ic_ui_move_tooltip .ic_piece_holder{background-repeat: no-repeat;background-position: 50% 50%;display: block;}";
		
		for(i=0, len=arr.length; i<len; i++){
			my_css+=".ic_ui_board .ic_font_merida .ic_"+arr[i]+"{background-image: url(\"https://ajax333221.github.io/isepic-chess-ui/css/images/chess-fonts/merida/"+arr[i]+".png\");}";
		}
